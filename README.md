...
Given a TPM-normalized bulk RNA-seq dataset, script _5_ generates synthetic scRNA-seq data for any desired cell count. For comparison, the script also accepts scRNA-seq data, computes pseudo-bulk data, and returns a synthetic scRNA-seq dataset with a matching number of cells.
